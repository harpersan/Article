    ...
    <div class="w-full bg-indigo-100 h-screen flex flex-row flex-wrap justify-center ">
        ...
        <div class="w-0 md:w-1/4 lg:w-1/5 h-0 md:h-screen overflow-y-hidden bg-white shadow-lg">
            ...
            <div class="w-full h-screen antialiased flex flex-col hover:cursor-pointer">
                <a class="hover:bg-gray-200 bg-white border-t-2 py-3 px-10 w-full text-left text-gray-600 font-semibold"
                    href="/create-post"><i class="fas fa-plus text-gray-600 text-xl pr-1 pt-1 float-right"></i>Create Article</a>
                <a class="hover:bg-gray-200 bg-white border-t-2 border-b-2 py-3 px-10 w-full text-left text-gray-600 font-semibold"
                    href="/{{$users->name}}"><i class="fas fa-cog text-gray-600 text-xl pr-1 pt-1 float-right"></i>Dashboard</a>
            </div>
        </div>
                    ...
                    <table class="w-full text-md bg-white shadow-md rounded mb-4">
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                    ...
                                    <td class="p-3 px-5 w-1/3"><p class="bg-transparent">{{  substr(strip_tags($item->content),0,35)   }}</p> </td>
